...
const Cart = () => {
  const {products,navigate,cartCount,totalCartAmount,cartItems,removeFromCart
    ,updateCartItem,axios,user,setCartItems
  }=useContext(AppContext);
  //state to store the products which is available in cart
                                   ...
                                   <div className='flex items-center'>
                                    ...
                                    <select onChange={(e)=>updateCartItem(product._id,Number(e.target.value))}
                                        ...
                                        className='outline-none'>
                                            ...
                                            .fill("").map((_,index)=>(<option key={index} value={index+1}>{index+1}</option>))
